...
#             sorted_books.append(f"{key} - {', '.join(value)}")
#         else:
#             sorted_books.append(f"{key} - {value}")
#     return sorted_books
...
# def remove_book(author, book):
#     if author in books:
#         if isinstance(books[author], list):
#             if book in books[author]:
#                 books[author].remove(book)
#                 return True
#         elif book == books[author]:
#             books.pop(author)
#             return True
#     return False
